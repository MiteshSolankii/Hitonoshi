...
public class Enemy2 : Entity
{
    ...
    [SerializeField] private D_StunState stunStateData = null;
    [SerializeField] private D_DeadState deadStateData= null;
    [SerializeField] public  D_DodgeState dodgeStateData = null ;
    [SerializeField] private D_RangedAttackState rangedAttackStateData = null;

    [SerializeField] private Transform meleeAttackPosition = null;
    [SerializeField] private Transform rangedAttackPosition= null;
    ...
    public override void Damage(AttackDetails attackDetails)
    {
        ...
        else if (!CheckPlayerInMinAgroRange() && stateMachine.currentState != stunState)
        {
        ...
        if (!isDead)
        {
            E2Audiomanager.instance.PlaySound("E2Hurt");
        }
    }
